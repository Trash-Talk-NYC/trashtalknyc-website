...
- Wallet page (`/wallet`) — CSS-3D purple leather wallet with live GoFundMe total and Cleanups/Tree Guards initiative cards in the slot; linked from nav as "The Wallet" / "La Cartera"
