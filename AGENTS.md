...
The How-we-work and Why-email copy in the note is the **captain's own voice, approved verbatim (round 21)** — the exclamation marks, "the trusty phone call", "chatting it up", and the abrupt sentence rhythm are deliberate; do not smooth, formalize, or add connective tissue, in English or Spanish.
